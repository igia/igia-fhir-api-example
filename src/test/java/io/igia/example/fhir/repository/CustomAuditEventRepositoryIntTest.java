 ...
 */
package io.igia.example.fhir.repository;
...
import io.igia.example.fhir.config.audit.AuditEventConverter;
import io.igia.example.fhir.domain.PersistentAuditEvent;
import io.igia.example.fhir.repository.CustomAuditEventRepository;
import io.igia.example.fhir.repository.PersistenceAuditEventRepository;
...
import static io.igia.example.fhir.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
