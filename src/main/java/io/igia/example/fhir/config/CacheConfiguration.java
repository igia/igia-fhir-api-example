...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("igiafhirapiexample");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("igiafhirapiexample");
        ...
        config.getMapConfigs().put("io.igia.example.fhir.domain.*", initializeDomainMapConfig(jHipsterProperties));
